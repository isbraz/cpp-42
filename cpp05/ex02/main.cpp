...
int main()
{
    ...
    try
    {
        ...
        std::cout << static_cast<const AForm&>(shrub);
    ...
    try
    {
        ...
        std::cout << static_cast<const AForm&>(robot);
    ...
    try
    {
        ...
        std::cout << president;
        std::cout << static_cast<const AForm&>(pardon);
        std::cout << WHITE << "Attempting to sign..." << RESET << std::endl;
    ...
    try
    {
        ...
        std::cout << static_cast<const AForm&>(unsignedForm);
